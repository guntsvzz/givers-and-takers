...
class InterestsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interest" do
    assert_difference("Interest.count") do
      post interests_url, params: { interest: { delivery_method: @interest.delivery_method, quantity: @interest.quantity, user_id: @interest.user_id } }
    end
  ...
  test "should update interest" do
    patch interest_url(@interest), params: { interest: { delivery_method: @interest.delivery_method, quantity: @interest.quantity, user_id: @interest.user_id } }
